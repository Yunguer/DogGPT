...
export function UserChat({image}) {
    ...
    if(typeof image != "undefined") {
        ...
        return(
            <svg style={{'min-width': '3em', 'min-height': '3em', 'max-width': '3em', 'max-height': '3em'}} stroke="black" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="3em" width="3em" xmlns="http://www.w3.org/2000/svg"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
        )
    }
}